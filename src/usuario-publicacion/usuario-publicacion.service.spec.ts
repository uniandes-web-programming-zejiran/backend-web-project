...
describe('UsuarioPublicacionService', () => {
  ...
  it('addPublicacionUsuario deberia agregar una publicacion a un usuario', async () => {
    ...
    const result: UsuarioEntity = await service.addPublicacionUsuario(
      newUsuario.id,
      newPublicacion.id,
    );
    ...
    expect(result.publicaciones[0].fechaPublicacion).toBe(
  ...
  it('addPublicacionUsuario deberia lanzar una excepcion si el usuario no existe', async () => {
    ...
    await expect(() =>
      service.addPublicacionUsuario(newUsuario.id, '0'),
  ...
  it('addPublicacionUsuario deberia lanzar una excepcion si el usuario no existe', async () => {
    ...
    await expect(() =>
      service.addPublicacionUsuario('0', newPublicacion.id),
    ).rejects.toHaveProperty(
      'message',
  ...
  it('findPublicacionByUsuarioIdPublicacionId deberia retornar una publicacion', async () => {
    ...
    const storedPublicacion: PublicacionEntity =
      await service.findPublicacionByUsuarioIdPublicacionId(
        usuario.id,
        publicacion.id,
      );
    ...
    expect(storedPublicacion.fechaPublicacion).toBe(
  ...
  it('findPublicacionByUsuarioIdPublicacionId deberia lanzar una excepcion si la publicacion no existe', async () => {
    await expect(() =>
      service.findPublicacionByUsuarioIdPublicacionId(usuario.id, '0'),
    ).rejects.toHaveProperty(
      'message',
      'La publicacion con el id dado no fue encontrada',
    );
  ...
  it('findPublicacionByUsuarioIdPublicacionId deberia lanzar una excepcion si el usuario no existe', async () => {
    const publicacion: PublicacionEntity = publicacionesList[0];
    await expect(() =>
      service.findPublicacionByUsuarioIdPublicacionId('0', publicacion.id),
    ).rejects.toHaveProperty(
      'message',
      'El usuario con el id dado no fue encontrado',
    );
  ...
  it('findAllPublicacionesByUsuarioId deberia retornar una exceptcion por una publicacion no asociada a un usaurio', async () => {
    ...
    await expect(() =>
      service.findPublicacionByUsuarioIdPublicacionId(
        usuario.id,
        newPublicacion.id,
      ),
    ).rejects.toHaveProperty(
      'message',
      'La publicacion con el id dado no esta asociada al usuario',
    );
  });
  ...
  it('findPublicacionesByUsuarioId deberia retornar todas las publicaciones de un usuario', async () => {
    const publicaciones: PublicacionEntity[] =
      await service.findPublicacionByUsuarioId(usuario.id);
  ...
  it('findPublicacionesByUsuarioId deberia lanzar una excepcion si el usuario no existe', async () => {
    await expect(() =>
      service.findPublicacionByUsuarioId('0'),
    ).rejects.toHaveProperty(
      'message',
      'El usuario con el id dado no fue encontrado',
    );
  ...
  it('assosiatePublicacionUsuario deberia actualizar las publicaciones de un usuario', async () => {
    ...
    const updatedUsuario: UsuarioEntity =
      await service.associatePublicacionUsuario(usuario.id, [newPublicacion]);
    ...
    expect(updatedUsuario.publicaciones[0].fechaPublicacion).toBe(
      newPublicacion.fechaPublicacion,
    );
  ...
  it('assosiatePublicacionUsuario deberia lanzar una excepcion si el usuario no existe', async () => {
    ...
    await expect(() =>
      service.associatePublicacionUsuario('0', [newPublicacion]),
    ).rejects.toHaveProperty(
      'message',
      'El usuario con el id dado no fue encontrado',
    );
  ...
  it('assosiatePublicacionUsuario deberia lanzar una excepcion si la publicacion no existe', async () => {
    ...
    await expect(() =>
      service.associatePublicacionUsuario(usuario.id, [newPublicacion]),
    ).rejects.toHaveProperty(
      'message',
      'La publicacion con el id dado no fue encontrada',
    );
  ...
  it('deletePublicacionUsuario deberia eliminar una publicacion de un usuario', async () => {
    ...
    const deletedPublicacion: PublicacionEntity =
      storedUsuario.publicaciones.find((p) => p.id === publicacion.id);
  ...
  it('deletePublicacionUsuario deberia lanzar una excepcion si la publicacion no existe', async () => {
    await expect(() =>
      service.deletePublicacionUsuario(usuario.id, '0'),
    ).rejects.toHaveProperty(
      'message',
      'La publicacion con el id dado no fue encontrada',
    );
  ...
  it('deletePublicacionUsuario deberia lanzar una excepcion si el usuario no existe', async () => {
    const publicacion: PublicacionEntity = publicacionesList[0];
    await expect(() =>
      service.deletePublicacionUsuario('0', publicacion.id),
    ).rejects.toHaveProperty(
      'message',
      'El usuario con el id dado no fue encontrado',
    );
  ...
  it('deletePublicacionUsuario deberia lanzar una excepcion si la publicacion no está asociada al usuario', async () => {
    ...
    await expect(() =>
      service.deletePublicacionUsuario(usuario.id, newPublicacion.id),
    ).rejects.toHaveProperty(
      'message',
      'La publicacion con el id dado no esta asociada al usuario',
    );
