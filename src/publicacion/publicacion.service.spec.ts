...
describe('PublicacionService', () => {
    ...
    it('findOne deberia retornar una publicacion por id', async () => {
        ...
        expect(publicacion.fechaPublicacion).toEqual(storedPublicacion.fechaPublicacion)
    ...
    it('create deberia crear una publicacion', async () => {
        ...
        expect(storedPublicacion.fechaPublicacion).toEqual(newPublicacion.fechaPublicacion)
