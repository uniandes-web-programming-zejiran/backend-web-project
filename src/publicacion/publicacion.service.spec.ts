...
describe('PublicacionService', () => {
  ...
  it('findOne deberia retornar una publicacion por id', async () => {
    ...
    expect(publicacion.fechaPubliacion).toEqual(
      storedPublicacion.fechaPubliacion,
    );
  ...
  it('create deberia crear una publicacion', async () => {
    ...
    expect(storedPublicacion.fechaPubliacion).toEqual(
      newPublicacion.fechaPubliacion,
    );
